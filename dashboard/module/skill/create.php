<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $class = $_POST['class'];
        //query SQL
        $query = "INSERT INTO skill (name, persen_val, class) VALUES('$name','$percent','$class')"; 
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="biodata" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link active" href="<?php echo '../../module/biodata/create.php';?>">Add Biodata</a>
                                </nav>
                            </div>
                    ...
                    <div class="container mt-3">
                        ...
                        <form action="create.php" method="POST">
                            ...
                            <div class="mb-3 mt-3">
                                ...
                                <input type="text" class="form-control" id="percent" placeholder="Enter Percentage" name="percent">
                            </div>
                            <div class="mb-3">
                                <label for="class">Class:</label>
                                <input type="text" class="form-control" id="class" placeholder="Enter Name Class" name="class">
                            </div>
